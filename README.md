...
[![Python Tests](https://github.com/liu-jj01/fastapi-passenger-security-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liu-jj01/fastapi-passenger-security-api/actions/workflows/tests.yml)
...
```env
APP\\\_NAME=接口练习项目
DATABASE\\\_URL=sqlite:///./passenger.db
API\\\_KEY=替换为你自己的真实密钥
```
...
```text
X-API-Key: 你在 .env 中配置的 API\\\_KEY
```
...
# 检查 Python 文件语法
python -m compileall app migrations main.py test\\\_main.py
```
